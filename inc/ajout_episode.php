...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if (!empty($nom) && !empty($date_sortie) && $serie_id !== false && $serie_id !== null) {
        ...
        $sql = "INSERT INTO episode (nom, vignette, date_sortie, resume, serie_id) VALUES (:nom, :vignette, :date_sortie, :resume, :serie_id)";
    ...
    if($succes){
        header('Location: ../public/liste_episode.php');
        exit;
    }
    }
